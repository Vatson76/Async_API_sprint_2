...
@social_network.route("/login/google/", methods=["GET"])
@rate_limit()
def login_google():
...
@social_network.route("/auth/google/", methods=["GET"])
@rate_limit()
def auth_google():
    google_service = register_google()
...
@social_network.route("/login/yandex/", methods=["GET"])
@rate_limit()
def login_yandex():
...
@social_network.route("/auth/yandex/", methods=["GET"])
@rate_limit()
def auth_yandex():
